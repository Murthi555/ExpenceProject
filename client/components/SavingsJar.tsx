...
export default function SavingsJar({ initial }: { initial: SavingsState }) {
          ...
          <div className="order-2 md:order-1 md:col-span-2">
            <div className="relative mx-auto h-64 w-48 rounded-[28px] border border-yellow-200 bg-white shadow-inner">
              <div className="absolute inset-x-2 bottom-2 rounded-b-[24px] overflow-hidden">
                <div
                  className="h-60 w-full origin-bottom rounded-b-[24px] bg-gradient-to-b from-yellow-200 via-yellow-300 to-yellow-400 transition-transform duration-700"
